          ...
          {sampleFiles.map((file) => (
            ...
            >
              <div className="p-6">
                ...
                <h3
                  className="text-lg font-semibold text-gray-800 text-center mb-2 truncate"
                  title={file.name}
                >
                  {file.name}
                </h3>
              ...
              <div className="w-full h-full min-h-[60vh] relative">
                <iframe
                  src={`https://docs.google.com/gview?url=${encodeURIComponent(
                    window.location.origin + viewingFile.url
                  )}&embedded=true`}
                  ...
                  onLoad={() => {
                    ...
                    if (iframe) {
                      ...
                      if (iframeDocument) {
                        const exstandElement =
                          iframeDocument.querySelector(".exstand"); // استبدل بالاختيار المناسب
                        if (exstandElement) {
